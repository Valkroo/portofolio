        ...
        <div class="max-w-xl bg-slate-100 mx-auto">
            <form action="/login" method="post" class="font-inter mx-auto shadow-xl p-6 rounded-md ">
                ...
                <div class="mb-6">
                    ...
                    <input type="password" id="password" name="password" class="shadow text-sm appearance-none border focus:border-2 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:border-blue-400 focus:outline-blue-400 focus:shadow-lg focus:shadow-blue-100" required placeholder="********" value="{{ old('password') }}">
                </div>
